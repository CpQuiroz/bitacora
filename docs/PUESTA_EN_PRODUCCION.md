...
**Última migración aplicada a producción: `63` (2-sep-2026, `supabase db push` con el CLI linkeado a prod; tracking `remote:63` OK, CI de migraciones en verde).** Actualizar este número a mano cada vez que se aplique una migración nueva a prod.
