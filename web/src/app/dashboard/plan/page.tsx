...
export default function PlanPage() {
  ...
  return (
    ...
    >
      <PageHeader title="Plan" subtitle={`Plan actual: ${usuario.empresa.plan}`} />
      <Card className="my-6">
        <p className="text-sm text-muted">Todavía no hay gestión de planes/facturación de la suscripción desde acá.</p>
      </Card>
    </DashboardShell>
  );
}
