...
>
> **Actualizado 12-sep-2026.** La app **ya está publicada en internet** (Vercel + Render +
...
a **toda la web** (las 7 pantallas del sidebar + la shell) y a mobile. **Paso 7 (12-sep,
...
`levantamiento_materiales`/`levantamiento_fotos`—, **100 migraciones, todas aplicadas y
trackeadas en prod**).
