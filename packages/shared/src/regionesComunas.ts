// Catálogo estático de regiones y comunas de Chile (división vigente,
// incluye Ñuble separada de Biobío). Dato de referencia fijo — no lo
// edita el usuario, por eso vive acá como constante y no como tabla.
export const REGIONES_COMUNAS: Record<string, string[]> = {
  ...
  "Metropolitana de Santiago": [
    ...
    "Santiago", "Talagante", "Til Til", "Vitacura",
  ],
  ...
  "Los Ríos": [
    "Corral", "Futrono", "Lago Ranco", "Lanco", "Los Lagos", "Máfil",
    "Mariquina", "Paillaco", "Panguipulli", "Río Bueno", "La Unión", "Valdivia",
  ],
  "Los Lagos": [
